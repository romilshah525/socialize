...
<body>
				...
				<div class="col-lg-12">
					<div class="box">
						<div class="box-footer clearfix">
							<form action="uploadPost?userId=${userId}" method="post">
								<button class="kafe-btn kafe-btn-mint-small pull-right btn-sm" type="submit">Upload</button>
								<ul class="nav nav-pills nav-sm">
									<li class="nav-item">
										<a id="uploadPostItems" class="nav-link" href="javascript:void(0);">
				                  ...
				                  -o-background-size: cover;">
											<div class="story-body text-center">
												<p></p>
												 	...
												 	<input id="post_selector" name="post_selector" type="hidden" style="display: none;">
    ...
    <!-- <div style="display: none;">
      <img src="" alt="" id="previewImg" width="300" height="300" />
    </div>
	 -->
	...
	<script>
		...
		var post_selector = document.getElementById("post_selector");
		...
		widget.onUploadComplete((fileInfo) => {
	    	  ...
	    	  toDataURL(fileInfo.cdnUrl, function(dataUrl) {
    			  ...
    			  preview.style.backgroundImage = "url("+dataUrl+")";//"url('img_tree.png')";
					...
					post_selector.setAttribute("value",fileInfo.name);
...
/* 		 camera_icon.addEventListener("click", function(){
		...
		post_selector.addEventListener("change", function(){
