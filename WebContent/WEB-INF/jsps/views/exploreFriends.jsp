				...
				<div class="col-lg-8 col-lg-offset-2">
					<div class="followers-box full-width">
						<div class="followers-list">
							...
							<c:forEach items="${exploreFriends}" var="user">
								<c:if test="${user.getId() ne userId }">
									<div class="followers-body">
										<img class="img-responsive img-circle" src="data:image/jpg;base64,${user.getProfileImage()}" alt="">
										<div class="name-box">
											<a href="profile?userId=${userId}&profileId=${user.getId()}">
												<h4>${user.getName()}</h4>
												...
												<ul class="list-group">
													<li class="list-group-item full-width">
														<div class="pull-left" style="margin-right: 20px;">
															<c:forEach items="${user.getFriendsId()}" var="friend" end="3">
																<img src="data:image/jpg;base64,${userService.getProfileImageOfUser(friend)}" alt=""
																class="img-circle max-w-40 ">
																
															</c:forEach>
															<c:if test="${user.getFriendsId().size() ne 0}">
																<button class="btn btn-add-gray">
																	<i class="fa fa-plus"></i>
																</button>
															</c:if>
												
															<span> ${user.getFriendsId().size()} Followers </span>
											...
											<span><a href="followFromExploreFriends?userId=${userId}&requestPersonId=${user.getId()}" class="kafe-btn kafe-btn-mint-small">
												Follow</a>
											</span>
