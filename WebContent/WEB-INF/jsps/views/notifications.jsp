				...
				<div class="col-lg-8 col-lg-offset-2">
					<ul>
						...
						<c:forEach items="${allNotifications}" var="notification">
							...
							<c:set var="notificationUser" value="${ userService.getUserWithId( notification.getNotificationFromUserId() ) }"/>
							
							<c:if test="${notification.getTypeOfNotification() == 'REQUEST' }">
								<li>
									<div class="media first_child">
										<img src="data:image/jpg;base64,${notificationUser.getProfileImage()}" alt="" class="img-responsive img-circle">
										<div class="media_body">
											<p>
											<a href="profile?userId=${userId}&profileId=${notificationUser.getId()}">
												<strong>${notificationUser.getName()}</strong>
											</a>started following you.</p>
											<h6>5 minutes ago</h6>
											<div class="btn_group">
												<a href="acceptFollowRequest?userId=${userId}&notificationId=${notification.getId()}" class="kafe-btn kafe-btn-mint"><i class="fa fa-check"></i></a>
												<a href="rejectFollowRequest?userId=${userId}&notificationId=${notification.getId()}" class="kafe-btn kafe-btn-red"><i class="fa fa-times"></i></a>
											</div>
										</div>
									</div>
								</li>
								...
								<li>
									<div class="media first_child">
										...
										<p>
											...
											commented on your <a href="seePost?userId=${userId}&postId=${notification.getPostId()}&profileId=${notification.getNotificationForUserId()}"><span class="emp">photo</span>.</a></p>
											<h6>5 minutes ago</h6>
										</div>
									</div>
								</li>
							...
							<c:if test="${notification.getTypeOfNotification() == 'LIKE' }">
								<li>
									<div class="media first_child">
										<img src="data:image/jpg;base64,${notificationUser.getProfileImage()}" alt="" class="img-responsive img-circle">
										<div class="media_body">
											<p><a href="profile?userId=${userId}&profileId=${notificationUser.getId()}">
												<strong>${notificationUser.getName()}</strong>
											</a>
											liked your <a href="seePost?userId=${userId}&postId=${notification.getPostId()}&profileId=${notification.getNotificationForUserId()}"> <span class="emp">photo</span>.</a></p>
											<h6>5 minutes ago</h6>
										</div>
									</div>
								</li>
